...
class RobotiumUtils {
     ...
     * 
     * @param keycode
     *            the key code to be sent. Use {@link KeyEvent#KEYCODE_ENTER}, {@link KeyEvent#KEYCODE_MENU}, {@link KeyEvent#KEYCODE_DEL},
     ...
     * 
     * @param viewList
     *            an {@code ArrayList} with {@code View}s that is being checked for invisible {@code View}s.
    ...
    public static <T extends View> ArrayList<T> filterViews(final Class<T> classToFilterBy, ArrayList<View> viewList) {
        final ArrayList<T> filteredViews = new ArrayList<T>(viewList.size());
     ...
     * @param view
     *            the view to check
     * @param uniqueTextViews
     *            set of views that have matched
